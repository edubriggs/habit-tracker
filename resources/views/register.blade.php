<x-layout>
  <main class="py-10">
    <section class="bg-white max-w-[600px] mx-auto p-10 pb-6 border-2 mt-4">
      ...
      <h1 class="font-bold text-3xl">Registre-se</h1>
      ...
      <form action="{{ route('auth.register') }}" method="POST" class="flex flex-col">
        ...
        <button
          type="submit"
          class="bg-white border-2 p-2 hover:opacity-70"
        >
          Cadastrar
        </button>
      </form>
      <p class="text-center mt-4">
        Já tem uma conta? <a href="{{ route('site.login') }}" class="underline hover:opacity-60 transition">Faça login</a>
      </p>
